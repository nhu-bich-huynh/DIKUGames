...
/// <summary>
/// Represents the game winning state of the game.
/// </summary>
public class GameWinning : IGameState, IGameEventProcessor
{
    private static GameWinning? instance;
    ...
    /// <summary>
    /// Returns the singleton instance of the GameWinning state.
    /// </summary>   
    public static GameWinning GetInstance()
    {
        StaticTimer.PauseTimer();

        if (GameWinning.instance == null)
        {
            GameWinning.instance = new GameWinning();
            GameWinning.instance.ResetState();
        }
        return GameWinning.instance;
    }
    ...
    public void ProcessEvent(GameEvent gameEvent)
    {
        ...
        {
            case "Game Winning Score":
                _text = new Text("You Win!", new Vec2F(0.2f, 0.4f), new Vec2F(0.4f, 0.4f));
